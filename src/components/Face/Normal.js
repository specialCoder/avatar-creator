...
const Normal = (props = {}) => {
  const { earColor, neckColor, shadowColor, faceColor, noseColor } = {
    ...defaultProps,
    ...props
  };
  ...
  return (
    <>
      <g id="Face_Normal" clipPath="url(#clip0_92_380)">
        {/* <g id="Head"> */}
        ...
        <path
          id="Face"
          d="M45.8874 36.0992C45.8874 45.0216 44.5016 55.9932 33.5016 55.9932C22.5015 55.9932 17.43 45.0216 17.43 36.0992C15.0016 25.5 15.5015 13 32.0016 13C48.5016 13 45.8874 27.1767 45.8874 36.0992Z"
          fill={faceColor}
        />
        <rect
          id="Nose"
